...
const tiers: {
...
}[] = [
  {
    ...
    price: "₹0",
    per: "forever",
    perks: ["2 free unlocks + 1/day", "Post your ride", "Basic matching"],
  },
  {
    id: "weekly",
    name: "Weekly pass",
    price: "₹19",
    per: "7 days",
    perks: ["4 unlocks/day for 7 days", "Priority matching", "All connect options"],
  },
  {
    id: "monthly",
    name: "Monthly",
    price: "₹49",
    per: "30 days",
    perks: ["4 unlocks/day for 30 days", "Priority matching", "Boosted ride post visibility"],
    highlight: true,
  },
];
