...
const tiers: {
...
}[] = [
  {
    ...
    price: "₹0",
    per: "forever",
    perks: ["2 Requests Per Day", "Post your ride", "Basic matching"],
  },
  {
    id: "weekly",
    name: "Weekly",
    price: "₹19",
    per: "7 days",
    perks: ["5 Requests Per Day", "Valid For 7 Days", "Priority matching"],
  },
  {
    id: "monthly",
    name: "Monthly",
    price: "₹49",
    per: "30 days",
    perks: ["8 Requests Per Day", "Valid For 30 Days", "Priority matching", "Boosted ride post visibility"],
    highlight: true,
  },
];
